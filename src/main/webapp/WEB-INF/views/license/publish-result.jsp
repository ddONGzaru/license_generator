									...
									<div class="col-md-12">
										...
										<div class="widget widget-scrolling" style="height: 347px;">
											<div class="widget-header">
												<h3><i class="fa fa-lightbulb-o"></i> Result</h3>												
											</div>
												...
												<ul class="list-unstyled activity-list">
													...
													<li>
														...
														<p style="margin: 9px 0px;">
															<span class="text-primary">라이센스 발급 요청</span>이 완료되었습니다.
														</p>
													</li>
													<li>
														<i class="fa fa-info activity-icon pull-left icon-primary"></i>
														<p style="margin: 9px 0px;">
															아래 라이센스 발급 키로 <a href="#" class="text-primary">라이센스 상세정보</a> 메뉴에서 라이센스 파일을 획득할 수 있습니다.
														</p>
													</li>
													<li>
														<i class="fa fa-lock activity-icon pull-left icon-danger"></i>
														<p style="margin: 9px 0px;">
															<span><i class="fa fa-plus-square"></i></span>
															<span class="text-danger">${licenseGenKey}</span>
														</p>
													</li>
													<li></li>
												</ul>
